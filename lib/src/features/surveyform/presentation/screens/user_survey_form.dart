...
import 'package:survey_app/src/features/common/presentation/widgets/custom_scorll_physics.dart';
import 'package:survey_app/src/features/common/presentation/widgets/custom_snackbar.dart';
import 'package:survey_app/src/features/surveyform/data/models/user_answer_model.dart';
...
class _SurveyFormScreenState extends State<SurveyFormScreen> {
  ...
  void _submitForm() async {
    ...
    bool isSuccessfullySaved = await _surveyDataProvider.saveUserFormInputs(widget.formId, formData);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Consumer<SurveyDataProvider>(builder: (ctx, provider, child) {
        return Column(
          children: [
            Expanded(
                ...
                children: [
                  ...
                  if (currentIndex <= widget.questions.length - 1)
                    ElevatedButton(
                      ...
                      child: provider.isUploadingForm
                          ? const Padding(
