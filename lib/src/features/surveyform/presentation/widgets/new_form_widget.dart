...
class _NewFormState extends State<NewForm> {
  ...
  void _submit(){
    ...
    for (var j =0; j< surveyDataProvider.questions.length;j++) {
      final index = j;
      final question = surveyDataProvider.questions[j];
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Consumer<SurveyDataProvider>(builder: (ctc, provider, child) {
            if(provider.isLoadingData){
              return const CircularProgressIndicator();
            }else if(provider.questions.isNotEmpty){

              return Column(
                children: surveyDataProvider.questions
                    .asMap()
                    .entries
                    .map((entry) {
          ...
          ElevatedButton(
            onPressed: surveyDataProvider.questions.isEmpty ? null : _submit,
